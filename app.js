...
const dailyFile = require('./app/config/dailyfile.config.js')
const fileUpload = require('./app/config/fileupload.config.js')
const picUpload = require('./app/config/picupload.config.js')
...
require('./app/routers/pic.router.js')(app, fileRouter, picUpload)
require('./app/routers/file.router.js')(app, fileRouter, dailyFile)
require('./app/routers/file.router.js')(app, fileRouter, fileUpload)
