		...
		function(t, e, n) {
			...
			function _(t) {
				...
				for (
					'string' == typeof t
						? (r = t.split(/\s*,\s*/))
						: 'function' == typeof t ? (r = [ t ]) : ht.isArray(t) && (r = t),
						e = 0;
					e < r.length;
					e++
				)
						...
						(e.prototype.computeTitleFormat = function(t) {
							...
							return 'year' === e
								...
								: 'month' === e
									...
									: t.currentUnzonedRange.as('days') > 1 ? 'll' : 'LL';
						}),
						...
						(t.prototype._getTimeText = function(t, e, n, i, r) {
							return (
								...
								this.displayEventTime && !n
									? r && e ? this.view.formatRange({ start: t, end: e }, !1, i) : t.format(i)
									: ''
							);
						}),
			...
			function u(t) {
				for (var e, n = [], i = /\[([^\]]*)\]|\(([^\)]*)\)|(LTS|LT|(\w)\4*o?)|([^\w\[\(]+)/g; (e = i.exec(t)); )
					e[1]
						...
						: e[2]
							? n.push({ maybe: u(e[2]) })
							: e[3] ? n.push({ token: e[3] }) : e[5] && n.push.apply(n, d(e[5]));
				return n;
			}
			function d(t) {
				return '. ' === t ? [ '.', ' ' ] : [ t ];
				...
				for (e = 0; e < t.length; e++)
					(n = t[e]),
						'string' == typeof n
							? i.push('[' + n + ']')
							: n.token
								? n.token in E ? i.push(b + '[' + n.token + ']') : i.push(n.token)
					...
					return (
						...
						(e.prototype.computeColHeadFormat = function() {
							return this.rowCnt > 1 || this.colCnt > 10
								? 'ddd'
								: this.colCnt > 1 ? this.opt('dayOfMonthFormat') : 'dddd';
						}),
						...
						(e.prototype.renderNumberCellHtml = function(t) {
							...
							return s || this.cellWeekNumbersVisible
								? ((e = this.getDayClasses(t)),
									...
									s && (r += i.buildGotoAnchorHtml(t, { class: 'fc-day-number' }, t.format('D MMMM'))),
									(r += '</td>'))
								: '<td/>';
						}),
					...
					return (
						...
						(t.prototype.buildEventDefs = function(t) {
							...
							for (
								!0 === n
									? (r = [ {} ])
									: i.isPlainObject(n) ? (r = [ n ]) : i.isArray(n) && ((r = n), (o = !0)),
									e = 0;
								e < r.length;
								e++
							)
								...
								this.dateProfile.activeUnzonedRange.containsDate(t)
									? (r.push('fc-' + a.dayIDs[t.day()]),
										...
										t.isSame(n, 'day')
											...
											: t < n ? r.push('fc-past') : r.push('fc-future'))
				...
				s = (function() {
					...
					return (
						...
						(t.prototype.buildDateIncrement = function(t) {
							...
							return n
								? i.duration(n)
								: (e = this.opt('dateAlignment')) ? i.duration(1, e) : t || i.duration({ days: 1 });
						}),
						t
					);
				})();
													...
													g &&
														...
														(w = i(
															...
															.hover(
																...
																function() {
																	w
																		.removeClass(o.getClass('stateHover'))
