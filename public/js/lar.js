	...
	var calendar = $('#calendar').fullCalendar({
        ...
        drop: function(date, jsEvent,ui,resourceId) { // this function is called when something is dropped
            ...
            if (resourceId.type == 'agendaDay') { 
                ...
                seTime = new Date(copiedEventObject.start).getHours()-7 + new Date(copiedEventObject.start).getMinutes()/60
                eeTime = new Date(copiedEventObject.end).getHours() + new Date(copiedEventObject.end).getMinutes()/60
            ...
            if (copiedEventObject.title !== null && createEvent) {
                ...
                if (copiedEventObject.start !== null) {
                        ...
                        data.start = new Date(copiedEventObject.start._d.getTime()-25200000);
                        }
                    }
                    else {
                        data.start = null;
